...
DMENU=" dmenu -i -nb #1c1c1c -nf #fbf1c7 -sb #fbf1c7 -sf #1c1c1c -fn JetBrainsMono:pixelsize=16 -l 2 -p "
#-nb '#1d2021' -nf '#ebdbb2' -sb '#ebdbb2' -sf '#1d2021'
...
#    done < <(grep-desktop)
    ...
    choice=$(printf '%s\n' "${options[@]}" | dmenu -i -nb '#1d2021' -nf '#ebdbb2' -sb '#ebdbb2' -sf '#1d2021' -fn 'JetBrainsMono:pixelsize=16' -p 'Auf Wiedersehen' -l 6 "${@}")
    echo $choice
